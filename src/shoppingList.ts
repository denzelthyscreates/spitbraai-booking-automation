...
interface MenuPackage {
  meat: { [key: string]: MenuItemData };
  sides: { [key: string]: MenuItemData };
  condiments: { [key: string]: MenuItemData };
  equipment: { [key: string]: MenuItemData };
}

export class ShoppingListService {
  private menuPackages: { [key: string]: MenuPackage } = {
  ...
  async generateShoppingList(booking: Booking): Promise<ShoppingItem[]> {
